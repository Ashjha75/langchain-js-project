  ...
  theme: {
    ...
    extend: {
      ...
      borderRadius: {
        ...
        'message': '1rem',
        'user-message': '1rem 1rem 0.25rem 1rem',
        'assistant-message': '1rem 1rem 1rem 0.25rem',
      },
      ...
      boxShadow: {
        ...
        'elevated': '0 8px 16px -4px rgba(0, 0, 0, 0.1), 0 6px 8px -4px rgba(0, 0, 0, 0.1)',
