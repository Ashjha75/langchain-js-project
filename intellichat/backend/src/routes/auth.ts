 ...
 * @access  Public
 */
router.post('/reset-password', validateBody(resetPasswordBodySchema), authController.requestPasswordReset);
 ...
 * @access  Private
 */
router.post('/change-password', authenticateJWT, validateBody(changePasswordBodySchema), authController.changePassword);
 ...
 * @access  Private
 */
router.put('/profile', authenticateJWT, validateBody(updateProfileBodySchema), authController.updateProfile);
